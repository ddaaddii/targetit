        ...
        <div class="card-body">
            ...
            <form method="POST" action="/usuarios">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <select  class="form-control"  name="tipos_usuarios_id" id="tipos_usuarios_id"  data-placeholder="Selecione o tipo de usuario">
                            @foreach ($tipos_usuarios as $tipo)
                                <option {{ old('tipos_usuarios_id') == $tipo->id ? 'selected' : '' }} value="{{ $tipo->id }}">{{ $tipo->perfil_acesso }}</option>
                            @endforeach
                         </select>
